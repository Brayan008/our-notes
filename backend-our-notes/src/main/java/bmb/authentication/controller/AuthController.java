...
public class AuthController {
  ...
  public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
    ...
    if(user.isEmpty()){
        return ResponseHandler.generateResponse("Usuario no encontrado porfavor registrate.", 
    ...
    return ResponseHandler.generateResponse("Sesion iniciada correctamente.", 
              HttpStatus.OK, 
              new JwtResponse(jwt, 
                         userDetails.getId(), 
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    if (userRepository.existsByUsername(signUpRequest.getUsername())) {
      return ResponseHandler.generateResponse("Error: Este usuario ya existe", 
              HttpStatus.BAD_REQUEST, 
              null, true);
    }

    if (userRepository.existsByEmail(signUpRequest.getEmail())) {
      return ResponseHandler.generateResponse("Error: Este correo electronico ya existe", 
              HttpStatus.BAD_REQUEST, 
              null, true);
    ...
    return ResponseHandler.generateResponse("Usuario registrado correctamente.", 
              HttpStatus.OK, 
              user, false);
  }
}
